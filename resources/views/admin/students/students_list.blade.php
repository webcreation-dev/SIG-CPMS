            ...
            <div class="col-12">
                @can('access-manager')
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="{{route('fiche.calcul.global')}}" style="" target="_blank"><button class="btn btn-md btn-warning mb-15 float-end" type="button" ><i class="fa fa-file-pdf-o"></i> Fiche de calcul global</button></a>
                        </div>
                    </div>
                @endcan
