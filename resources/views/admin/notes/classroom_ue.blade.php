        ...
        <div class="themebody-wrap">
            ...
            <div class="codex-breadcrumb">
                ...
                <div class="left-breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Enregistrement des notes</a></li>
                    </ul>
                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title">1ère Etape</h5><a href="javascript:void(0);" data-bs-dismiss="modal"><i class="ti-close"></i></a>
                          </div>
                          <div class="modal-body">

                          <form action="{{ route('notes.create') }}" method="GET" id="ue-form">
                              @csrf

                              <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="form-label">Classe</label>
                                    <select class="form-control basic-select" name="classroom_id">
                              ...
                              <div class="row">
                                  <div class="form-group col-md-12">
                                      ...
                                      <select class="form-control basic-select" name="ue_id">
                                        <option>Selectionnez UE..</option>
                                        @foreach ($teaching_units as  $item)
                                            <option value={{$item->id}}>{{$item->name}}</option>
                                        @endforeach
                                        @foreach ($element_teaching_units as  $item)
                                            <option value={{$item->id}}>{{$item->name}}</option>
                                        @endforeach
                                      </select>
                                  </div>
                              ...
                              <button type="submit" class="btn btn-success btn-md">CONTINUER</button>
