...
<html dir="ltr" lang="fr">
  <head>
    ...
    <title>Mon Compte - Colis entrants - Aucun colis</title>
    <script>
    ...
    <link rel="StyleSheet" href="https://www.shipito.com/fr/account/incoming-packages/no-packages" type="text/css">
    ...
    <script async="" src="files/modules.62ff59481fe32f68ae9b.js.téléchargement" charset="utf-8"></script>
          ...
          <ul class="nav navbar-nav navbar-right st-navbar-tabs">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a href="https://www.shipito.com/en/account/incoming-packages/no-packages" class="st-language-option ignore-warnings">English</a>
                </li>
                <li>
                  <a href="https://www.shipito.com/ar/account/incoming-packages/no-packages" class="st-language-option ignore-warnings">العربية</a>
                </li>
                <li>
                  <a href="https://www.shipito.com/zh/account/incoming-packages/no-packages" class="st-language-option ignore-warnings">简体中文</a>
                </li>
                <li>
                  <a href="https://www.shipito.com/zt/account/incoming-packages/no-packages" class="st-language-option ignore-warnings">繁體中文</a>
                </li>
                <li>
                  <a href="https://www.shipito.com/cs/account/incoming-packages/no-packages" class="st-language-option ignore-warnings">čeština</a>
                </li>
                <li>
                  <a href="https://www.shipito.com/de/account/incoming-packages/no-packages" class="st-language-option ignore-warnings">Deutsch</a>
                </li>
                <li>
                  <a href="https://www.shipito.com/he/account/incoming-packages/no-packages" class="st-language-option ignore-warnings">עברית</a>
                </li>
                <li>
                  <a href="https://www.shipito.com/ja/account/incoming-packages/no-packages" class="st-language-option ignore-warnings">日本語</a>
                </li>
                <li>
                  <a href="https://www.shipito.com/pt/account/incoming-packages/no-packages" class="st-language-option ignore-warnings">português</a>
                </li>
                <li>
                  <a href="https://www.shipito.com/ru/account/incoming-packages/no-packages" class="st-language-option ignore-warnings">русский</a>
                </li>
                <li>
                  <a href="https://www.shipito.com/es/account/incoming-packages/no-packages" class="st-language-option ignore-warnings">español</a>
                </li>
                <li>
                  <a href="https://www.shipito.com/tr/account/incoming-packages/no-packages" class="st-language-option ignore-warnings">Türk</a>
                </li>
              </ul>
            </li>
            <li>
    ...
    <div id="page-content" class="page-content">
      <div class="main-body">
        <div class="container package-list">
          <h1>Et maintenant ?</h1>
          <p> Avec votre nouvelle adresse Shipito, vous pouvez commencer vos achats sur presque tous les sites internet. Il vous suffit simplement d’utiliser cette nouvelle adresse lors de vos commandes. Nous vous informons de l'arrivée de vos articles à l'entrepôt. </p>
