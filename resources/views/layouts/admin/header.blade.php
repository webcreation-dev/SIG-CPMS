            ...
            <div class="search-bar">
              <div class="form-group mb-0">
                <div class="input-group">
                  <input class="form-control" type="text" value="" placeholder="Rechercher ici....."><span class="input-group-text"><i data-feather="search"></i></span>
                </div>
              </div>
            </div>
          </div>
            ...
            <ul class="nav-iconlist">
              ...
              <li>
                ...
                <div class="hover-dropdown navnotification-drop">
                  ...
                  <div class="drop-footer"><a href="email-inbox.html">Voir Toutes Notification</a></div>
                </div>
              </li>
              <li>
                ...
                <div class="hover-dropdown navshop-drop">
                  <div class="drop-header">
                    <h5>Livraison<span>7</span></h5>
                  </div>
                  <ul data-simplebar>
                    <li><a href="javascript:void(0);">
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="{{asset('assets/images/ecom-dashboard/small-pro/1.jpg')}}" alt=""></div>
                          <div class="media-body">
                    ...
                    <li><a href="javascript:void(0);">
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="{{asset('assets/images/ecom-dashboard/small-pro/2.jpg')}}" alt=""></div>
                          <div class="media-body">
                    ...
                    <li><a href="javascript:void(0);">
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="{{asset('assets/images/ecom-dashboard/small-pro/3.jpg')}}" alt=""></div>
                          <div class="media-body">
                    ...
                    <li><a href="javascript:void(0);">
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="{{asset('assets/images/ecom-dashboard/small-pro/4.jpg')}}" alt=""></div>
                          <div class="media-body">
                    ...
                    <li><a href="javascript:void(0);">
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="{{asset('assets/images/ecom-dashboard/small-pro/5.jpg')}}" alt=""></div>
                          <div class="media-body">
                            <h6>iphone</h6><span class="text-light">$140</span>
                          </div>
                          <div class="close-pro"><i class="ti-trash"></i></div>
              ...
              <li class="nav-profile">
                <div class="media">
                  <div class="user-icon"><img class="img-fluid rounded-50" src="{{asset('files/user.png')}}" alt="logo"></div>
                  <div class="media-body">
                    <h6>Lazarre CHOUBIYI</h6><span class="text-light">Administrateur</span>
                  </div>
                </div>
