<NAV CLASS = "navbar navbar-default navbar-fixed-top st-navbar">
   ...
   <SPAN CLASS = "ga-caret hide-lg"></SPAN>
     ...
     <UL CLASS = "dropdown-menu dropdown-menu-left">
       <LI><A HREF = "/lynia-rewards">Lynia Delivery Pour Mois</A></LI>
       <LI><A HREF = "/lynia-for-business">Lynia Delivery Pour les Entreprises</A></LI>
     </UL>
   </LI>
   <LI CLASS = "dropdown">
    <A HREF = "#" data-toggle = "dropdown">
   ...
   <SPAN CLASS = "ga-caret hide-lg"></SPAN>
     ...
     <UL CLASS = "dropdown-menu dropdown-menu-left">
       ...
       <LI><A HREF = "/lynia-pricing">Tarifs et Options</A></LI>
       <LI><A HREF = "/faq">FAQs</A></LI>
       <LI><A HREF = "/postage">Modes de livraison</A></LI>
       <LI><A HREF = "/prohibited-items">Que puis-je expédier ?</A></LI>
     </UL>
   </LI>
   <LI CLASS = "dropdown">
    <A HREF = "#" data-toggle = "dropdown">
